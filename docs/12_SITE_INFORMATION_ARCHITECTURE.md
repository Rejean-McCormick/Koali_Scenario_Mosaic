...
## `/uses/properties`
Offline, multilingual, local-first, AI-optional, sensitive-data, public-facing, high-consequence.

## `/uses/start-from-my-need`
Human prompts such as: “I need to understand a problem,” “I need to find expertise,” “I need to organize a decision,” “I need to coordinate a disruption,” “I need to preserve what we learned,” “I need to publish knowledge.”

## `/uses/evidence`
Claim model, canonical references, validated vs composed uses.
