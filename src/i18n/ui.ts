...
export const ui = {
  en: {
    ...
    selectCellPrompt: 'Click a hexagonal cell to discover a scenario.',
    ...
    mosaicDescription: '120 scenarios arranged as a compact 20 by 6 honeycomb panorama. Eight scenario families are named directly across their color territories.',
    mosaicHint: 'Territory names are embedded in the map. Hover or focus one hexagon to inspect a scenario above.',
  ...
  fr: {
    ...
    selectCellPrompt: 'Cliquez sur une cellule hexagonale pour découvrir un scénario.',
    ...
    mosaicDescription: '120 scénarios disposés dans un panorama compact en nid d’abeilles de 20 par 6. Les huit familles sont nommées directement dans leurs territoires de couleur.',
    mosaicHint: 'Les noms des territoires vivent dans la carte. Survolez ou ciblez un hexagone pour examiner un scénario ci-dessus.',
