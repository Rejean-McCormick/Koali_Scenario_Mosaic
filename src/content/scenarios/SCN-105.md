...
preview_summary: A public policy is reassessed after two years. The work is over, but the learning can still be lost. Koali links outcomes back to the decisions, assumptions, cases and evidence that produced them, so experience can change the next procedure, project or decision.
preview_image: /scenarios/images/scenario_105.png
preview_image_alt: 'Abstract illustration for SCN-105: A public policy is reassessed after two years'
badges:
- PUBLIC
related:
- SCN-104
