---
id: SCN-114
title: A school publishes student projects
...
preview_summary: A school publishes student projects. Knowledge needs to reach people beyond the original working group. Koali keeps the public explanation, learning resource or media object connected to its source knowledge, provenance and revisions while it is adapted for new audiences.
preview_image: /scenarios/images/scenario_114.png
preview_image_alt: 'Abstract illustration for SCN-114: A school publishes student projects'
badges:
- PUBLIC
related:
- SCN-113
...
- SCN-099
---
# SCN-114 — A school publishes student projects
...
A school publishes student projects. Knowledge needs to become a usable public or learning format—course, guide, video, audio, library, or channel—without becoming disconnected from its source.
...
`project → evidence → review → publication → inspiration`
...
The value is not any one isolated feature. It is preserving the same context across **project → … → inspiration** so knowledge, people, choices, work, and memory remain connected.

## Transferable to

science · public-service · culture
