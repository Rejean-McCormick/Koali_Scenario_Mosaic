...
preview_summary: A city investigates why one district overheats. The situation starts with incomplete or scattered evidence. Koali keeps observations, sources, history and relevant expertise connected around the same question, so understanding can develop without losing provenance or the link to what happens next.
preview_image: /scenarios/images/scenario_014.png
preview_image_alt: 'Abstract illustration for SCN-014: A city investigates why one district overheats'
badges: []
related:
- SCN-013
- SCN-015
