---
id: SCN-111
title: A trade turns rare expertise into a public tutorial
...
preview_summary: A trade turns rare expertise into a public tutorial. Knowledge needs to reach people beyond the original working group. Koali keeps the public explanation, learning resource or media object connected to its source knowledge, provenance and revisions while it is adapted for new audiences.
preview_image: /scenarios/images/scenario_111.png
preview_image_alt: 'Abstract illustration for SCN-111: A trade turns rare expertise into a public tutorial'
badges:
- PUBLIC
related:
- SCN-110
...
- SCN-096
---
# SCN-111 — A trade turns rare expertise into a public tutorial
...
A trade turns rare expertise into a public tutorial. Knowledge needs to become a usable public or learning format—course, guide, video, audio, library, or channel—without becoming disconnected from its source.
...
`expertise → capture → review → tutorial → dissemination → adaptations`
...
The value is not any one isolated feature. It is preserving the same context across **expertise → … → adaptations** so knowledge, people, choices, work, and memory remain connected.
