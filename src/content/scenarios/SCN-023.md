...
preview_summary: A museum creates a learning path from its collection. Valuable know-how exists in practice, but it risks remaining local, tacit, or attached to one person or session.
preview_image: /scenarios/placeholders/SCN-023.svg
preview_image_alt: 'Abstract illustration for SCN-023: A museum creates a learning path from its collection'
badges: []
related: []
---
