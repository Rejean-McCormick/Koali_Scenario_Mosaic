...
preview_summary: A coach compares the game plan with the result. Individual cases make sense on their own, but the real value comes from comparing them across time to detect recurrence and change.
preview_image: /scenarios/placeholders/SCN-098.svg
preview_image_alt: 'Abstract illustration for SCN-098: A coach compares the game plan with the result'
badges: []
related: []
---
