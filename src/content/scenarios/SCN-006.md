...
preview_summary: A museum needs to establish an artwork's provenance. The situation starts with incomplete or scattered evidence. Koali keeps observations, sources, history and relevant expertise connected around the same question, so understanding can develop without losing provenance or the link to what happens next.
preview_image: /scenarios/images/scenario_006.png
preview_image_alt: 'Abstract illustration for SCN-006: A museum needs to establish an artwork''s provenance'
badges: []
related:
- SCN-005
- SCN-007
