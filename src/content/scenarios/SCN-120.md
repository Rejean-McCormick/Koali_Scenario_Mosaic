...
preview_summary: An audiovisual archive flags content that has become outdated. Published media must remain connected to the knowledge and version it depends on so outdated material can be flagged or revised.
preview_image: /scenarios/placeholders/SCN-120.svg
