...
preview_summary: A farmer compares ten seasons of practice. The work is over, but the learning can still be lost. Koali links outcomes back to the decisions, assumptions, cases and evidence that produced them, so experience can change the next procedure, project or decision.
preview_image: /scenarios/images/scenario_099.png
preview_image_alt: 'Abstract illustration for SCN-099: A farmer compares ten seasons of practice'
badges:
- FIELD
- OFFLINE
related:
