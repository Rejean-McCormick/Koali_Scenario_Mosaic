---
id: SCN-108
title: An agricultural cooperative shares a proven method
...
preview_summary: An agricultural cooperative shares a proven method. Knowledge needs to reach people beyond the original working group. Koali keeps the public explanation, learning resource or media object connected to its source knowledge, provenance and revisions while it is adapted for new audiences.
preview_image: /scenarios/images/scenario_108.png
preview_image_alt: 'Abstract illustration for SCN-108: An agricultural cooperative shares a proven method'
badges:
- FIELD
- OFFLINE
related:
...
- SCN-093
---
# SCN-108 — An agricultural cooperative shares a proven method
...
An agricultural cooperative shares a proven method. Knowledge needs to become a usable public or learning format—course, guide, video, audio, library, or channel—without becoming disconnected from its source.
...
`practice → evidence → review → tutorial → dissemination → field feedback`
...
The value is not any one isolated feature. It is preserving the same context across **practice → … → field feedback** so knowledge, people, choices, work, and memory remain connected.
