---
id: SCN-118
title: A municipality opens a public knowledge center
...
preview_summary: A municipality opens a public knowledge center. Knowledge needs to reach people beyond the original working group. Koali keeps the public explanation, learning resource or media object connected to its source knowledge, provenance and revisions while it is adapted for new audiences.
preview_image: /scenarios/images/scenario_118.png
preview_image_alt: 'Abstract illustration for SCN-118: A municipality opens a public knowledge center'
badges:
- PUBLIC
- MULTILINGUAL
related:
...
- SCN-103
---
# SCN-118 — A municipality opens a public knowledge center
...
A municipality opens a public knowledge center. Knowledge needs to become a usable public or learning format—course, guide, video, audio, library, or channel—without becoming disconnected from its source.
...
`public objects → selection → explanation → media library → residents`
...
The value is not any one isolated feature. It is preserving the same context across **public objects → … → residents** so knowledge, people, choices, work, and memory remain connected.
