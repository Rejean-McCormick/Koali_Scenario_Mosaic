...
preview_summary: A Product Manager wants to understand a user need. The evidence needed to understand what is happening is spread across observations, prior cases, documents, systems, or people.
preview_image: /scenarios/placeholders/SCN-010.svg
preview_image_alt: 'Abstract illustration for SCN-010: A Product Manager wants to understand a user need'
badges: []
related: []
---
