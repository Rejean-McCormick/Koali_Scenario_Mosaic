...
preview_summary: A restaurant asks which changes actually improved service. The work is over, but the learning can still be lost. Koali links outcomes back to the decisions, assumptions, cases and evidence that produced them, so experience can change the next procedure, project or decision.
preview_image: /scenarios/images/scenario_097.png
preview_image_alt: 'Abstract illustration for SCN-097: A restaurant asks which changes actually improved service'
badges: []
related:
- SCN-096
- SCN-098
